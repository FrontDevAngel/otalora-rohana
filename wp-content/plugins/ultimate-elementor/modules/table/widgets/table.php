		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf( __( '%1$sRead more%2$s about creating Table by Uploading CSV.', 'uael' ), '<a href="https://uaelementor.com/docs/create-table-by-uploading-csv/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">', '</a>' ),
					...
					$repeater->add_control(
						...
						[
							...
							'selectors'  => [
								...
								'(mobile){{WRAPPER}}.uael-table--responsive {{CURRENT_ITEM}}.uael-table-col' => 'width: 100%;',
							],
							'condition'  => [
								'header_content_type' => 'cell',
							],
			...
			$this->start_controls_tab( 'tab_header_colors_row', [ 'label' => __( 'Default', 'uael' ) ] );
				...
				$this->add_group_control(
					...
					[
						...
						'selector'       => '{{WRAPPER}} thead tr.uael-table-row, {{WRAPPER}} tbody .uael-table-row th, {{WRAPPER}}.uael-table--responsive .uael-no-column-rules tr, {{WRAPPER}}.uael-table--responsive .uael-no-column-rules tr',
						'condition'      => [
