	...
	protected function register_input_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .uael-gf-style .gfield input:focus, {{WRAPPER}} .uael-gf-style .gfield textarea:focus, {{WRAPPER}} .uael-gf-style .gfield select:focus,
						{{WRAPPER}} .uael-gf-style .gfield_checkbox input[type="checkbox"]:checked + label:before, {{WRAPPER}} .uael-gf-style .gfield_radio input[type="radio"]:checked + label:before' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .uael-gf-style .gfield input:focus, {{WRAPPER}} .uael-gf-style .gfield textarea:focus, {{WRAPPER}} .uael-gf-style .gfield select:focus, {{WRAPPER}}.uael-gf-style-underline .gfield_checkbox input[type="checkbox"]:checked + label:before, {{WRAPPER}}.uael-gf-style-underline .gfield_radio input[type="radio"]:checked + label:before' => 'border-color: {{VALUE}};',
				],
			]
		);
