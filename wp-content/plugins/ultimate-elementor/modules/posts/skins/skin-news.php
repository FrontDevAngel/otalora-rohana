...
class Skin_News extends Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/uael-posts/news_section_terms_field/before_section_end', [ $this, 'register_update_tax_content_controls' ] );
	 ...
	 * @access public
	 */
	public function register_update_tax_content_controls() {

		$this->remove_control( 'terms_position' );
